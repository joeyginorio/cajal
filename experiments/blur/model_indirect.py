...
# ---------- Data --------------------
train_xs = torch.load("experiments/blur/data/train_xs.pt")
train_ys = torch.load("experiments/blur/data/train_ys.pt")

test_xs = torch.load("experiments/blur/data/test_xs.pt")
test_ys = torch.load("experiments/blur/data/test_ys.pt")
...
# cnn = CNN().to(device)
# cnn_path = "experiments/blur/data/mnist_cnn.pt"
...
with open("experiments/blur/data/indirect_loss_train.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
with open("experiments/blur/data/indirect_loss_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow(["step", "seed", "batch size", "lr", "loss"])
    for (step, seed, batch_size, lr), loss in loss_test.items():
        writer.writerow([step, seed, batch_size, lr, loss])
with open("experiments/blur/data/indirect_output_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
with open("experiments/blur/data/indirect_psnr_test.csv", "w", newline="") as f:
    writer = csv.writer(f)
