...
df5 = pd.read_csv("experiments/blur/data/direct_psnr_test.csv")
idf5 = pd.read_csv("experiments/blur/data/indirect_psnr_test.csv")
...
g.fig.savefig(
    "experiments/blur/figures/psnr_global.pdf",
    format="pdf",
