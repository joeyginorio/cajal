...
axes[3].set_ylim(0, 1)           # show just the first 500 updates
...
axes[4].set_ylim(0, 1)           # show just the first 500 updates
...
axes[5].set_ylim(13, 23)           # show just the first 500 updates
axes[5].set(
    xlabel="Steps",
    ylabel=""
)
