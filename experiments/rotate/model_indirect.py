...
class ModelI(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            ...
            nn.Conv2d(1,8,15,padding=7),
            nn.ReLU(),
            nn.Conv2d(8,1,15,padding=7),
            nn.Flatten(1,2)
        )
...
# with open("experiments/rotate/data/indirect_loss_train.csv", "w", newline="") as f:
#     writer = csv.writer(f)
...
# with open("experiments/rotate/data/indirect_loss_test.csv", "w", newline="") as f:
#     writer = csv.writer(f)
#     writer.writerow(["step", "seed", "batch size", "lr", "loss"])
#     for (step, seed, batch_size, lr), loss in loss_test.items():
#         writer.writerow([step, seed, batch_size, lr, loss])
# with open("experiments/rotate/data/indirect_output_test.csv", "w", newline="") as f:
#     writer = csv.writer(f)
...
# with open("experiments/rotate/data/indirect_psnr_test.csv", "w", newline="") as f:
#     writer = csv.writer(f)
