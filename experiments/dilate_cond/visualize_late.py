...
# df1 = pd.read_csv("experiments/dilate_cond/data/direct_loss_train.csv")
# df2 = pd.read_csv("experiments/dilate_cond/data/direct_loss_test.csv")
# df4 = pd.read_csv("experiments/dilate_cond/data/direct_output_test.csv")
# df5 = pd.read_csv("experiments/dilate_cond/data/direct_psnr_test.csv")

# tdf1 = pd.read_csv("experiments/dilate_cond/data/type_loss_train.csv")
# tdf2 = pd.read_csv("experiments/dilate_cond/data/type_loss_test.csv")
# tdf4 = pd.read_csv("experiments/dilate_cond/data/type_output_test.csv")
# tdf5 = pd.read_csv("experiments/dilate_cond/data/type_psnr_test.csv")

# idf1 = pd.read_csv("experiments/dilate_cond/data/indirect_loss_train.csv")
# idf2 = pd.read_csv("experiments/dilate_cond/data/indirect_loss_test.csv")
# idf4 = pd.read_csv("experiments/dilate_cond/data/indirect_output_test.csv")
# idf5 = pd.read_csv("experiments/dilate_cond/data/indirect_psnr_test.csv")
...
test_xs = torch.load("experiments/dilate_cond/data/test_xs.pt")
test_ys = torch.load("experiments/dilate_cond/data/test_ys.pt")
...
def get_test_out(lr, batch_size, idx, df):
    ...
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 500)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 1700)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 3000)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 4200)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 5500)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 6700)].iloc[0].output))
    test_out.append(eval(df[(df["lr"] == lr) & (df["batch size"] == batch_size) & (df["idx"] == idx) & (df["step"] == 8000)].iloc[0].output))
    return test_out
...
axes[5].set_ylim(13, 35)           # show just the first 500 updates
axes[5].set(
    xlabel="Steps",
    ylabel=""
)
...
fig.suptitle("Late learning dynamics", fontsize=20, x=.54, y=1., fontweight="bold")
...
fig.savefig(
    "experiments/dilate_cond/figures/late_dynamics.pdf",
    format="pdf",
