...
train_ds = datasets.MNIST("experiments/dilate_cond/data", train=True, download=True)
test_ds = datasets.MNIST("experiments/dilate_cond/data", train=False, download=True)
...
torch.save(xs_train, "experiments/dilate_cond/data/train_xs.pt")
torch.save(ys_train, "experiments/dilate_cond/data/train_ys.pt")
torch.save(xs_test, "experiments/dilate_cond/data/test_xs.pt")
torch.save(ys_test, "experiments/dilate_cond/data/test_ys.pt")
