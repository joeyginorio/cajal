...
# tdf1 = pd.read_csv("experiments/dilate_cond/data/type_loss_train2.csv")
# tdf2 = pd.read_csv("experiments/dilate_cond/data/type_loss_test2.csv")
# tdf4 = pd.read_csv("experiments/dilate_cond/data/type_output_test2.csv")
# tdf5 = pd.read_csv("experiments/dilate_cond/data/type_psnr_test2.csv")
...
fig.savefig(
    "experiments/dilate_cond/figures/early_dynamics.pdf",
    format="pdf",
