...
with open("experiments/dilate_cond/data/indirect_loss_train.csv", "a", newline="") as f:
    writer = csv.writer(f)
...
with open("experiments/dilate_cond/data/indirect_loss_test.csv", "a", newline="") as f:
    writer = csv.writer(f)
    writer.writerow(["step", "seed", "batch size", "lr", "loss"])
    for (step, seed, batch_size, lr), loss in loss_test.items():
        writer.writerow([step, seed, batch_size, lr, loss])
with open("experiments/dilate_cond/data/indirect_output_test.csv", "a", newline="") as f:
    writer = csv.writer(f)
...
with open("experiments/dilate_cond/data/indirect_psnr_test.csv", "a", newline="") as f:
    writer = csv.writer(f)
